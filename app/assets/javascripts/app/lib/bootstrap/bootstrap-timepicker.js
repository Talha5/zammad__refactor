  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      templateContent = '<table>'+
         '<tr>'+
           '<td><a href="#" data-action="incrementHour"><svg class="icon icon-arrow-up"><use xlink:href="#icon-arrow-up" /></svg>"></i></a></td>'+
           '<td class="separator">&nbsp;</td>'+
           '<td><a href="#" data-action="incrementMinute"><svg class="icon icon-arrow-up"><use xlink:href="#icon-arrow-up" /></svg>"></i></a></td>'+
           (this.showSeconds ?
             '<td class="separator">&nbsp;</td>'+
             '<td><a href="#" data-action="incrementSecond"><svg class="icon icon-arrow-up"><use xlink:href="#icon-arrow-up" /></svg>"></i></a></td>'
           : '') +
           (this.showMeridian ?
             '<td class="separator">&nbsp;</td>'+
             '<td class="meridian-column"><a href="#" data-action="toggleMeridian"><svg class="icon icon-arrow-up"><use xlink:href="#icon-arrow-up" /></svg>"></i></a></td>'
           : '') +
         '</tr>'+
         '<tr>'+
           '<td>'+ hourTemplate +'</td> '+
         ...
         '</tr>'+
         '<tr>'+
           '<td><a href="#" data-action="decrementHour"><svg class="icon icon-arrow-down"><use xlink:href="#icon-arrow-down" /></svg>"></i></a></td>'+
           '<td class="separator"></td>'+
           '<td><a href="#" data-action="decrementMinute"><svg class="icon icon-arrow-down"><use xlink:href="#icon-arrow-down" /></svg>"></i></a></td>'+
           (this.showSeconds ?
            '<td class="separator">&nbsp;</td>'+
            '<td><a href="#" data-action="decrementSecond"><svg class="icon icon-arrow-down"><use xlink:href="#icon-arrow-down" /></svg>"></i></a></td>'
           : '') +
           (this.showMeridian ?
            '<td class="separator">&nbsp;</td>'+
            '<td><a href="#" data-action="toggleMeridian"><svg class="icon icon-arrow-down"><use xlink:href="#icon-arrow-down" /></svg>"></i></a></td>'
           : '') +
         '</tr>'+
       '</table>';
